...
class User(Base):
    ...
    phone: Mapped[str] = mapped_column(String(20), default='default')
    business: Mapped[str] = mapped_column(String(20), default='default')
    position: Mapped[str] = mapped_column(String(20), default='default')
